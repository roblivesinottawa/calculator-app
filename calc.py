...
class App(Frame):
    ...
    def create_widgets(self):
        ...
        # these are all the buttons we need for the calculator
        ...
        self.Multibutton = Button(self, bg="#98DBC6", bd=12, 
        ...
        text="AC", font = ("Helvetica",20, "bold"), width=28, padx=9, command = self.ClearDisplay)
